...
<div class="blockcart_top clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if} pull-right hidden-xs hidden-sp">
{/if}
		...
		<div class="media heading">
			<div class="cart-inner media-body">	
				<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
					...
					<span class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}">{l s='0 item(s) - $0.00' mod='blockcart'}</span>
				...
				<div class="block_content">
					...
					<div class="cart_block_list{if isset($blockcart_top) && !$blockcart_top}{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)} expanded{else} collapsed unvisible{/if}{/if}">
						...
						<p class="cart-buttons clearfix">
							<a id="button_order_cart" class="btn button-medium button button-small pull-right" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Check out' mod='blockcart'}" rel="nofollow">
								<span>
