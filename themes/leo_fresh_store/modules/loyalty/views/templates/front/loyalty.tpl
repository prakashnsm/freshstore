...
<ul class="footer_links clearfix">
	...
	<li class="pull-right">
		<a class="btn btn-outline button button-small btn-sm" href="{$ap_shopping_dir}" title="{l s='Home' mod='loyalty'}"><span><i class="fa fa-home"></i>{l s='Home' mod='loyalty'}</span></a>
	</li>
</ul>
