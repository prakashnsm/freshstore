...
{if $error}
	<p class="alert alert-danger">
		...
		{elseif $error == 'cannot add friends'}
			{l s='Cannot add friends to dataap_shopping' mod='referralprogram'}
		{/if}
	</p>
{/if}
...
<ul class="footer_links clearfix">
	...
	<li class="pull-right"><a class="btn btn-outline button button-small btn-sm" href="{$ap_shopping_dir}" title="{l s='Home' mod='referralprogram'}"><span><i class="fa fa-home"></i>{l s='Home' mod='referralprogram'}</span></a></li>
</ul>
