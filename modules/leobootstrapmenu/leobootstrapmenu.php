...
class leobootstrapmenu extends Module {
    ...
    public function __construct() {
        ...
        $this->description = $this->l('Leo Bootstrap Megamenu Support Leo Framework Version 3.0');
        $this->Languages();
	...
	public function install()
	{
		/* Adds Module */
		if (parent::install() &&
			$this->registerHook('topNavigation')  && Configuration::updateValue('btmenu_iscache', 1)
                && Configuration::updateValue('btmenu_cachetime', 24) && Configuration::updateValue('LEO_MEGAMENU_CAVAS', 0))
		{
			$res = true;
