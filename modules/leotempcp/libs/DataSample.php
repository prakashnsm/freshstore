                    ...
                    if(isset($moduleXml->table_prefix)){
                        ...
                        foreach($prefixList as $pfl){
                            ...
                            foreach($listTable as $table){
                                ...
                                if (strpos(current($table), "leomanagewidget_backup") == false) $this->showcreateTable(current($table));
                            }
                        }
                    }
$this->_content .= '
...
$this->_content .= '
    ...
    foreach ($hook_list as $hook){
        ...
        $this->_content .= '
        <hook module="'.(string)$moduleXml->name.'" hook="'.$hook["name_hook"].'" position="'.$hook["position"].'" exceptions="'.$exception.'"/>';
    }
$this->_content .= '
    </hooks>';
$this->_content .= '
