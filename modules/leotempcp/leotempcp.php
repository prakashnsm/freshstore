...
class Leotempcp extends Module {
    ...
    public function __construct($createOnly = false) {
        ...
        if (!$createOnly) {
            ...
            $this->description = $this->l('Global Theme Panel To Configure Theme Skin, Customization, Layout, Development....(Version 3.0)');
...
{/if}';
    ...
    public function getPanelConfig($key, $default = '', $id_lang=null) {
        ...
        if (isset($_COOKIE[$this->themeCookieName.'_'.$key]) && $_COOKIE[$this->themeCookieName.'_'.$key])
            return $_COOKIE[$this->themeCookieName.'_'.$key];
