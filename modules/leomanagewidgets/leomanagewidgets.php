...
class LeoManagewidgets extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->l('Leo Manage Widget support Leo FrameWork Verion 4.0');
    }
            ...
            if ($row["params"]) {
                ...
                if ($isFont) {
                    ...
                    if (isset($myParam['background_style']) && $myParam['background_style']) {
                        ...
                        $bgStyle = (isset($myParam['background_style']) 
                                    && !empty($myParam['background_style'])) ? $myParam['background_style'] : '';
                        $bgStyleFullwidth = (isset($myParam['background_style_fullwidth']) 
                                    && !empty($myParam['background_style_fullwidth'])) ? $myParam['background_style_fullwidth'] : '0';
                        $bgStyleColor = (isset($myParam['background_style_color']) 
                                    && !empty($myParam['background_style_color'])) ? $myParam['background_style_color'] : '';
                        $bgStyleImageUrl = (isset($myParam['background_style_image_url']) 
                                    && !empty($myParam['background_style_image_url'])) ? $myParam['background_style_image_url'] : '';
                        $bgStylePosition = (isset($myParam['background_style_position']) 
                                    && !empty($myParam['background_style_position'])) ? $myParam['background_style_position'] : '';
                        $bgStyleRepeat = (isset($myParam['background_style_repeat']) 
                                    && !empty($myParam['background_style_repeat'])) ? $myParam['background_style_repeat'] : '';
                        $bgstyleParallaxSpeed = (isset($myParam['background_style_parallax_speed']) 
                                    && !empty($myParam['background_style_parallax_speed'])) ? $myParam['background_style_parallax_speed'] : '0.5';
                        $bgstyleParallaxOffsetx = (isset($myParam['background_style_parallax_offsetx']) 
                                    && !empty($myParam['background_style_parallax_offsetx'])) ? $myParam['background_style_parallax_offsetx'] : '0';
                        $bgstyleParallaxOffsety = (isset($myParam['background_style_parallax_offsety']) 
                                    && !empty($myParam['background_style_parallax_offsety']))    ? $myParam['background_style_parallax_offsety'] : '0';
                        $bgstyleMouseParallaxStrength = (isset($myParam['background_style_mouseparallax_strength']) 
                                    && !empty($myParam['background_style_mouseparallax_strength'])) ? $myParam['background_style_mouseparallax_strength'] : '0.5';
                        $bgstyleMouseParallaxAxis = (isset($myParam['background_style_mouseparallax_axis']) 
                                    && !empty($myParam['background_style_mouseparallax_axis'])) ? $myParam['background_style_mouseparallax_axis'] : 'both';
                        $bgstyleMouseParallaxOffsetX = (isset($myParam['background_style_mouseparallax_offsetx']) 
                                    && !empty($myParam['background_style_mouseparallax_offsetx'])) ? $myParam['background_style_mouseparallax_offsetx'] : '0';
                        $bgstyleMouseParallaxOffsetY = (isset($myParam['background_style_mouseparallax_offsety']) 
                                    && !empty($myParam['background_style_mouseparallax_offsety'])) ? $myParam['background_style_mouseparallax_offsety'] : '0';
                        $bgStyleVideoSource = (isset($myParam['background_video_source']) 
                                    && !empty($myParam['background_video_source'])) ? $myParam['background_video_source'] : '';
                        $bgStyleVideoId = (isset($myParam['background_video_vid']) 
                                    && !empty($myParam['background_video_vid'])) ? $myParam['background_video_vid'] : '';
                        $bgstyleVideoMp4 = (isset($myParam['background_video_mp4']) 
                                    && !empty($myParam['background_video_mp4'])) ? $myParam['background_video_mp4'] : '';
                        $bgstyleVideoWebm = (isset($myParam['background_video_webm']) 
                                    && !empty($myParam['background_video_webm'])) ? $myParam['background_video_webm'] : '';
                        $bgstyleVideoOgg = (isset($myParam['background_video_ogg']) 
                                    && !empty($myParam['background_video_ogg'])) ? $myParam['background_video_ogg'] : '';
    ...
    public function getBgStyleVideo($bgStyleVideoData = array())
    {
        ...
        }elseif(isset($bgStyleVideoData['type']) && $bgStyleVideoData['type'] === 'vimeo' 
            && isset($bgStyleVideoData['id']) && $bgStyleVideoData['id'] !== '')
        {
        ...
        }elseif(isset($bgStyleVideoData['type']) && $bgStyleVideoData['type'] === 'youtube' 
            && isset($bgStyleVideoData['id']) && $bgStyleVideoData['id'] !== '')
        {
    ...
    private function _processHook($hook_name)
    {
        ...
        if (!isset($this->_groupList[$hook_name])) return false;
        $groups = array();
...
//        }
    ...
    public static function execModuleHook($hook_name, $hook_args = array(), $module_name, $use_push = false, $id_shop = null)
    {
        ...
        if ($use_push && !$moduleInstance->allow_push) continue;
